...
class TvRatDataSource (private val apiService : TheMovieDBInterface, private val compositeDisposable: CompositeDisposable)
    ...
    override fun loadAfter(params: LoadParams<Int>, callback: LoadCallback<Int, Movie>) {
        networkState.postValue(NetworkState.LOADING)
        apiService.getTopRatedTv(params.key)
            .subscribeOn(Schedulers.io())
            .subscribe(
                {
